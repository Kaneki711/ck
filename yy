...
cl = LINETCR.LINE()
cl.login(token="EoaTrRLcnAnkcV3oDYs9.dKVw3xpTsB0QvQroj0VpIq.D6fVjhMFRznMnmvS4W/TH15K8QHHhtfhNqGLyCCMzfo=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EoFLQU77WFo5POjyiiZe.belVJ7MCwbwkSXaAOYZ4hG.qeqYaaANuHmbMZSITeakLlJKVNQxA/R5czzfp4Pvf6Y=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="Eo11JAhpChdZJNj55ELc.kT6iR169jqOfCEbXxwHDVa.tPLE5KgDxKg2hy4pB7fdQ/58vtOGK5OyepTqNuABKq4=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EoDwRjou3XrsyyQqw1ya.RQCE9wL3Mq5c3Ev1yfPIsG.gRFfBgS2t9OYscOy44PVVvev3Bn45gCDzfkkTkfy/n4=")
kc.loginResult()
...
def bot(op):
	...
	if op.type == 55:
		...
		if wait["lOn"][msg.to] == True: md+="Qr [Aktif]\n"
                ...
                cl.sendText(msg.to,"[â€¢] SETTINGS GROUP [â€¢]\n" + md)
